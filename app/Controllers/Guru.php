...
class Guru extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Daftar Materi',
            'materi'  => $this->MateriModel->orderBy("judul", "asc")->paginate(4, 'materi'),
    ...
    public function update($id_materi)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('guru/ubah/' . $id_materi)->withInput();
        }
        ...
        //flashdata pesan disimpan
        session()->setFlashdata('pesan', 'Materi Berhasil Dirubah!');
